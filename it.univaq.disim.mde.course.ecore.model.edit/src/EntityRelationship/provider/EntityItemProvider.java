...
public class EntityItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_incomingRelationships_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_incomingRelationships_feature", "_UI_Entity_type"),
				 EntityRelationshipPackage.Literals.ENTITY__INCOMING_RELATIONSHIPS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EntityRelationshipPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(EntityRelationshipPackage.Literals.ENTITY__RELATIONSHIPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityRelationshipPackage.Literals.ENTITY__ATTRIBUTES,
				 EntityRelationshipFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(EntityRelationshipPackage.Literals.ENTITY__RELATIONSHIPS,
