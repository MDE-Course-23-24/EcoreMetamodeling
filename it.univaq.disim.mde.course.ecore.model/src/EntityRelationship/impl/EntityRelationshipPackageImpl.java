...
import EntityRelationship.Cardinality;
...
public class EntityRelationshipPackageImpl extends EPackageImpl implements EntityRelationshipPackage {
	...
	public static EntityRelationshipPackage init() {
		...
		EntityRelationshipPackageImpl theEntityRelationshipPackage = registeredEntityRelationshipPackage instanceof EntityRelationshipPackageImpl ? (EntityRelationshipPackageImpl)registeredEntityRelationshipPackage : new EntityRelationshipPackageImpl();
	 ...
	 */
	@Override
	public EReference getEntity_IncomingRelationships() {
	...
	public void createPackageContents() {
		...
		createEReference(entityEClass, ENTITY__INCOMING_RELATIONSHIPS);
	...
	public void initializePackageContents() {
		...
		initEReference(getEntity_IncomingRelationships(), this.getRelationship(), this.getRelationship_Entity(), "incomingRelationships", null, 0, -1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRelationship_Cardinality(), this.getCardinality(), "cardinality", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationship_Entity(), this.getEntity(), this.getEntity_IncomingRelationships(), "entity", null, 1, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
